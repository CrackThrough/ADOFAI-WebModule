...
import AddText from "./action_classes/AddText.js";
...
import MoveDecorations from "./action_classes/MoveDecoration.js";
...
import ScreenScroll from "./action_classes/ScreenScroll.js";
import ScreenTile from "./action_classes/ScreenTile.js";
...
import SetText from "./action_classes/SetText.js";
...
class AdofaiMapAction {
    ...
    /**
     * This value stores legacy value generated in the constructor.
     *
     * AdofaiActionValue is in `ActionValue.js`.
     */
    ...
    constructor(floor, eventType, eventValue = null) {
        ...
        if (eventValue !== null) {
            ...
            const ThisClass = AdofaiMapAction.ACTIONS_LIST[eventType];
...
class Action {
     ...
     * @param {string} eventType type string of event
     */
