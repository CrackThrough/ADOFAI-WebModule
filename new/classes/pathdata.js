...
/**
 * Class expressing a single path tile.
 */
class PathData {
    /**
     * Creates PathData from 'code' or 'angle'.
     * @param {string | number} v the angle or path code
     */
    constructor(v) {
    ...
    get isAlwaysRelative() {
        if (this.isValid) return PathData.FindFromDictRaw(this.code)[2] ?? false;
    }
    ...
    /**
     * Find and returns found element inside the dictionary.
